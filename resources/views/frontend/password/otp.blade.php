        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    ...
                    <h1 class="page-banner-title">Your Email Check and Get Otp</h1>
                    ...
                    <div class="row">
                        <div class="col-md-6 m-auto">
                            <form action="{{ route('otp.match') }}" method="POST">
                                @csrf
                                <div class="mb-3">
                                    <label for="otp" class="text-light">OTP :</label>
                                    <input type="text" name="otp" class="bg-light" placeholder="otp here...">
                                    @error('otp')
