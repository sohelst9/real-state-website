...
@section('frontend_content')
    ...
    <div class="page-banner-section section">
        <div class="container">
            <div class="row">
                <div class="col">
                    <h1 class="page-banner-title">Edit Property</h1>
                ...
                <div class="add-property-wrap col">
                    <div class="add-property-form tab-content">
                        <div class="tab-pane show active" id="basic_info">
                            <div class="tab-body">
                                <form action="{{ route('agent.update.property', $property->id) }}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">

                                        <div class="col-12 mb-30">
                                            <label for="property_title"><span class="text-danger">*</span> Property
                                                Title</label>
                                        ...
                                        <div class="col-md-4 col-12 mb-30">
                                            <label for="property_area"><span class="text-danger">*</span> Area <span
                                        ...
                                        <div class="col-md-4 col-12 mb-30">
                                            ...
                                            <input type="text" id="p_city" readonly
                                        ...
                                        <div class="col-md-4 col-12 mb-30">
                                            ...
                                            <textarea name="p_map" id="p_map">{{ $property->p_map }}</textarea>
                                            @error('p_map')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-4 col-12 mb-30">
                                            <label for="p_thumbnail_image"><span class="text-danger">*</span> Thumbnail
                                                Image</label>
                                        ...
                                        <div class="col-md-4 col-12 mb-30">
                                            <label for="p_gallery_image">Gallery Image <span class="text-danger">(Multiple
                                        ...
                                        <div class="col-12 mb-30">
                                            <label for="p_description"><span class="text-danger">*</span>
                                                Description</label>
                                        ...
                                        <div class="nav d-flex justify-content-end col-12 mb-30 pl-15 pr-15">
                                            <button type="submit" class="property-submit btn">Update Property</button>
                                        </div>
...
<script>
    ...
    $(document).on('click', '.galleryImageDelete', function(){
        ...
        $.ajax({
            type:'GET',
            url:"/agent/galleryImage/"+gallery_id+"/delete",
            data:{
